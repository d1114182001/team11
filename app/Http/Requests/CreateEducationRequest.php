...
class CreateEducationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'junior_high_below_total' => 'required|integer',
            'junior_high_below_primary_total' => 'required|integer',
            'junior_high_total' => 'required|integer',
            'senior_high_total' => 'required|integer',
            'junior_college_above_total' => 'required|integer',
            'junior_college_total' => 'required|integer',
            'university_total' => 'required|integer',
            'graduate_school_total' => 'required|integer',

            'age_15_19' => 'required|integer',
            'age_20_24' => 'required|integer',

            'age_25_29' => 'required|integer',
            'age_30_34' => 'required|integer',
            'age_35_39' => 'required|integer',
            'age_40_44' => 'required|integer',

            'age_45_49' => 'required|integer',
            'age_50_54' => 'required|integer',
            'age_55_59' => 'required|integer',
            'age_60_64' => 'required|integer',

            'age_65_above_total' => 'required|integer',
        ];
    }
